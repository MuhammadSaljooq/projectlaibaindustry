    ...
    private function __construct() {
        try {
            ...
            $options = [
                ...
                PDO::MYSQL_ATTR_INIT_COMMAND => "SET SESSION wait_timeout=30, interactive_timeout=30", // Query timeout
            ];
            
            $this->pdo = new PDO($dsn, $username, $password, $options);
            
            // Set additional timeout for queries
            $this->pdo->setAttribute(PDO::ATTR_TIMEOUT, 10); // 10 second query timeout
