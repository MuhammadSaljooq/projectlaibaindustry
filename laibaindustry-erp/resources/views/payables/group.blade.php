...
<p class="text-[11px] text-[#586064] max-w-2xl">Invoices are split into open and settled sections like Receivables. Sales offsets are auto-applied latest invoice first, while direct combined payments are allocated oldest invoice first.</p>
...
<div>
<p class="st-label mb-1">Sales offset</p>
<p class="text-lg font-bold font-mono tabular-nums text-[#586064]">{{ $currencySymbol }} {{ number_format($groupTotals['total_sales_offsets'], 2) }}</p>
</div>
<div>
