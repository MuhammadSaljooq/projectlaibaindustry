...
<p class="text-lg font-bold font-mono tabular-nums text-[#2B3437]">{{ $currencySymbol }} {{ number_format($billTotal, 2) }}</p>
</div>
<div>
<p class="st-label mb-1">Total paid</p>
<p class="text-lg font-bold font-mono tabular-nums text-[#586064]">{{ $currencySymbol }} {{ number_format($paidTotal, 2) }}</p>
</div>
<div>
<p class="st-label mb-1">Total remaining</p>
<p class="text-lg font-black font-mono tabular-nums text-[#5E5E5E]">{{ $currencySymbol }} {{ number_format($outstanding, 2) }}</p>
</div>
</div>
</div>
...
@php $balance = max(0, (float) $p->amount - (float) $p->received); @endphp
<tr class="st-tr">
...
<td class="st-td px-4 py-3 text-sm font-mono font-bold text-right tabular-nums text-[#5E5E5E]">{{ $currencySymbol }} {{ number_format($balance, 2) }}</td>
