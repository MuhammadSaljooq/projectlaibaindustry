...
<html lang="en">
<head>
@include('partials.frontend-head', ['title' => 'Edit User - Laiba Safety'])
<style>
...
<div>
<h2 class="font-bold" style="font-size:1.5rem;letter-spacing:-0.02em;color:#2B3437;">Edit user</h2>
<p class="text-[10px] font-bold uppercase" style="letter-spacing:0.05em;color:#5E5E5E;margin-top:0.5rem;">Update account</p>
</div>
<span class="text-[10px] font-bold uppercase" style="letter-spacing:0.05em;color:#5E5E5E;">Form USR-{{ $user->id }}</span>
</div>
</div>
...
<span class="material-symbols-outlined" style="font-size:16px;">save</span>UPDATE USER
</button>
