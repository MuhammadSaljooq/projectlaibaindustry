...
<button type="submit" class="h-10 px-5 bg-black hover:bg-gray-800 text-white text-sm font-bold rounded-lg transition-colors whitespace-nowrap">Update User</button>
