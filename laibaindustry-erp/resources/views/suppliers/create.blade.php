...
<input class="st-input w-full h-10 px-3 text-sm" type="text" name="name" id="name" value="{{ old('name') }}" required maxlength="255" placeholder="Company or vendor name">
</div>
<div>
<label class="st-label block mb-2" for="country">Country</label>
<input class="st-input w-full h-10 px-3 text-sm" type="text" name="country" id="country" value="{{ old('country') }}" maxlength="128" placeholder="Optional">
</div>
<div>
<label class="st-label block mb-2" for="contact_name">Contact name</label>
<input class="st-input w-full h-10 px-3 text-sm" type="text" name="contact_name" id="contact_name" value="{{ old('contact_name') }}" maxlength="255" placeholder="Optional">
</div>
<div>
<label class="st-label block mb-2" for="phone">Phone</label>
<input class="st-input w-full h-10 px-3 text-sm" type="text" name="phone" id="phone" value="{{ old('phone') }}" maxlength="64" placeholder="Optional">
</div>
<div>
<label class="st-label block mb-2" for="email">Email</label>
<input class="st-input w-full h-10 px-3 text-sm" type="email" name="email" id="email" value="{{ old('email') }}" maxlength="255" placeholder="Optional">
</div>
<div>
<label class="st-label block mb-2" for="notes">Notes</label>
<textarea class="st-input w-full min-h-[100px] px-3 py-2 text-sm" name="notes" id="notes" placeholder="Optional">{{ old('notes') }}</textarea>
</div>
</div>
