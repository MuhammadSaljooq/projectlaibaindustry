...
<html lang="en">
<head>
@include('partials.frontend-head', ['title' => 'New Expense - Laiba Safety'])
<style>
...
<div>
<h2 class="font-bold" style="font-size:1.5rem;letter-spacing:-0.02em;color:#2B3437;">Create expense</h2>
<p class="text-[10px] font-bold uppercase" style="letter-spacing:0.05em;color:#5E5E5E;margin-top:0.5rem;">New cost entry</p>
</div>
<span class="text-[10px] font-bold uppercase" style="letter-spacing:0.05em;color:#5E5E5E;">Form EXP-NEW</span>
</div>
</div>
...
<input class="arch-input w-full h-11 px-4 text-sm font-bold" type="date" name="date" id="date" value="{{ old('date', now()->format('Y-m-d')) }}" required>
</div>
<div style="margin-bottom:1.5rem;">
...
<input class="arch-input w-full h-11 px-4 text-sm font-bold" type="text" name="type" id="type" value="{{ old('type') }}" placeholder="e.g. Rent, Utilities, Office supplies" required>
</div>
<div style="margin-bottom:1.5rem;">
...
<input class="arch-input w-full h-11 px-4 text-sm font-bold font-mono text-right tabular-nums" type="number" name="amount" id="amount" value="{{ old('amount') }}" step="0.01" min="0" placeholder="0.00" required>
</div>
...
<span class="material-symbols-outlined" style="font-size:16px;">save</span>SAVE EXPENSE
</button>
