...
<p class="text-[10px] font-bold uppercase tracking-[0.2em] text-[#586064]">EXP_OPEX_15</p>
...
<form method="GET" action="{{ route('expenses.index') }}" class="flex flex-wrap items-end gap-4 p-5 bg-[#F8F9FA] border border-[#ABB3B7]">
...
<input class="st-input w-full h-10 pl-10 pr-3 text-sm" id="e-search" type="text" name="search" value="{{ request('search') }}" placeholder="Expense type…">
</div>
</div>
...
<a href="{{ route('expenses.index') }}" class="st-btn-secondary h-10 px-4 inline-flex items-center gap-2">
...
<script>
(function () {
    document.querySelectorAll('tr[data-expense-edit-url]').forEach(function (row) {
