...
<html lang="en">
<head>
@include('partials.frontend-head', ['title' => 'Receivables by customer - ERP'])
...
<p class="text-[10px] font-bold uppercase tracking-[0.2em] text-[#586064]">AR_BY_CUSTOMER</p>
...
<form method="post" action="{{ route('receivables.group.payments.store', ['groupKey' => $groupKeyEncoded]) }}" class="flex flex-col sm:flex-row sm:flex-wrap gap-4 sm:items-end">
@csrf
