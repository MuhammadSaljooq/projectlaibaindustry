...
$navItems = [
    ...
    ['key' => 'suppliers',   'icon' => 'storefront',             'label' => 'Suppliers',   'route' => route('suppliers.index', absolute: false)],
    ...
    ['key' => 'international_payables', 'icon' => 'payments',    'label' => 'International payables', 'route' => route('international-payables.index', absolute: false)],
