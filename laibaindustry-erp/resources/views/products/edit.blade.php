...
{{-- Page Heading --}}
<div>
<span class="text-[11px] font-medium uppercase block mb-2" style="letter-spacing:0.2em;color:#8e9192;">Modify Entry</span>
<h2 class="text-white font-black" style="font-size:2rem;letter-spacing:-0.02em;line-height:1.1;">Edit Product</h2>
<p class="text-sm font-medium" style="color:#C4C7C8;margin-top:0.5rem;">{{ $product->name }} <span style="color:#8e9192;">/ {{ $product->sku }}</span></p>
</div>
...
<p class="text-xs font-medium mt-1" style="color:#8e9192;">Permanently delete this product from inventory.</p>
</div>
