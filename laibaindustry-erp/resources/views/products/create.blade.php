...
<html lang="en">
<head>
@include('partials.frontend-head', ['title' => 'Add Product - ERP'])
</head>
...
<h2 class="text-xl font-bold text-slate-800 dark:text-white">Add Product</h2>
</div>
</header>
...
<button type="submit" class="h-10 px-5 bg-primary hover:bg-blue-600 text-white text-sm font-bold rounded-lg transition-colors whitespace-nowrap">Save Product</button>
